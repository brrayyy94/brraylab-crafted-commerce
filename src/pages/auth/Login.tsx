  ...
  return (
    <div className="container max-w-md py-20">
      <div className="bg-surface border border-subtle rounded-2xl p-8 shadow-elevated">
        ...
        <p className="text-muted-foreground text-sm mb-8">Bienvenido de vuelta a BrrayLab.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center">
              ...
              <Link to="/auth/recuperar" className="text-xs text-primary-glow hover:underline">
                ¿Olvidaste?
              </Link>
            </div>
            <Input
